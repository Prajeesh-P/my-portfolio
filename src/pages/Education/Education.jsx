  ...
  const educationData = [
    {
      ...
      mascot: "🎓",
      year: "2017 - 2021",
      achievements: ["Specialization: Electronics and Communication Engineering"],
      skills: ["Web Development", "JavaScript", "React.js"],
      description:
        "Pursued undergraduate studies with a focus on software development and modern web technologies.",
    },
  ];
